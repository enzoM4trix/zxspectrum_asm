...
;Przesuwanie postaci zanim sie go z nowu narysuje
        ...
        ld bc,63486     ;klawiatura rzad 1-5/joystick port 2
        in a,(c)        ;see what keys are pressed
        rra             ;outermost bit = key 1
        push af         ;remember the value
        call nc,mpl     ;jesli  zostal nacisniety przesun w lewo
        pop af          ;restore accumulator
        rra             ;nastepny bit (value 2) = key 2
        push af         ;remember the value
        call nc,mpr     ;jesli zostal wcisniety przesun w prawo mpr to procedura
        pop af          ;restore accumulator
        rra             ;next bit (value 4) = key 3
        push af         ;remember the value
        call nc,mpd     ;wywolanie procedury przesun w dol
        pop af          ;restore accumulator
        rra             ;next bit (value 8) reads key 4
        call nc,mpu     ;wcisniety to przesun do gory
...
mpr     ld hl,ply       ;remember, y is the horizontal coord!
        ...
        cp 31           ;is it at the tight edge (31)?
